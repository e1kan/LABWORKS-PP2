...
#loading background
background = pygame.image.load(r"C:\Users\Eva\Desktop\hello\University\LabWorks\Lab9\images\AnimatedStreet.png")

#creating ENEMY class
class Enemy(pygame.sprite.Sprite):
      def __init__(self):
        super().__init__()
        self.image = pygame.image.load(r"C:\Users\Eva\Desktop\hello\University\LabWorks\Lab9\images\enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(r"C:\Users\Eva\Desktop\hello\University\LabWorks\Lab9\images\player.png")
        self.rect = self.image.get_rect()
...
class BasicCoin(Coin):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(r"C:\Users\Eva\Desktop\hello\University\LabWorks\Lab9\images\coin_basic.png")
        self.rect = self.image.get_rect()
        self.points = 1
...
class SuperCoin(Coin):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(r"C:\Users\Eva\Desktop\hello\University\LabWorks\Lab9\images\coin_super.png")
        self.rect = self.image.get_rect()
        self.points = 3
...
class BestCoin(Coin):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(r"C:\Users\Eva\Desktop\hello\University\LabWorks\Lab9\images\coin_best.png")
        self.rect = self.image.get_rect()
        self.points = 5
...
pygame.mixer.music.load(r"C:\Users\Eva\Desktop\hello\University\LabWorks\Lab9\sounds\background_racer.wav")
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
          ...
          pygame.mixer.Sound(r"C:\Users\Eva\Desktop\hello\University\LabWorks\Lab9\sounds\crash_racer.wav").play()
          time.sleep(0.5)
    ...
    for coin in coins:
        if pygame.sprite.spritecollideany(P1, coins):
            pygame.mixer.Sound(r"C:\Users\Eva\Desktop\hello\University\LabWorks\Lab9\sounds\pickedcoin.mp3").play()
            COINS_COLLECTED += 1
            POINTS += coin.points
